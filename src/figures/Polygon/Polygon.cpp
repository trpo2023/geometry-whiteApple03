...
bool Polygon::check_intersection(Figure& another_figure)
{
    ...
    if ((another_name == "triangle" or another_name == "polygon") and intersection.polygon_with_polygon(first_coord, second_coord)) {
        return true;
    } else if (another_name == "circle" and intersection.polygon_with_circle(first_coord, second_coord, another_figure.get_some_infomation())) {
        return true;
    }
